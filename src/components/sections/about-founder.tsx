...
export default async function AboutFounder() {
    ...
    const { name, username, role, avatar = "/images/profile-abdi.jpg", location, university, major } =
        data?.metadata || {};

    return (
        <section id="founder" className="py-24 px-6 bg-background border-t border-neutral-200 dark:border-neutral-800">
            <div className="max-w-6xl mx-auto space-y-16">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-neutral-500 mt-2 max-w-2xl">
                        Mengenal visi, pendekatan, dan komitmen profesional yang menggerakkan setiap solusi di Devflow.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24">
                        <div className="relative aspect-square overflow-hidden rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center p-0 shadow-inner group">
                            ...
                            <Image
                                src={avatar}
                                alt={`${name ?? "Founder"} - Founder Devflow`}
                                fill
                                priority
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <MagicCard className="p-5 border-neutral-200 dark:border-neutral-800" gradientColor="#171717">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span className="font-bold text-xs uppercase tracking-widest">Curriculum Vitae</span>
                                    </div>
                                    <p className="text-xs text-neutral-500 leading-relaxed mb-4">
                                        Unduh CV terbaru untuk melihat ringkasan pengalaman, keterampilan, dan portofolio secara lengkap.
                                    </p>
                                    <a
