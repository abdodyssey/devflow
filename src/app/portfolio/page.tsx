    ...
    <article className="min-h-screen h-full pb-20 pt-10 bg-background text-foreground">
      ...
      <div className="mx-auto max-w-4xl px-6 mt-20 text-center md:text-left space-y-4">
        ...
        <p className="text-neutral-500 text-lg max-w-2xl">
          Eksplorasi solusi digital, arsitektur sistem, dan inovasi teknologi
          yang dibangun dengan presisi oleh devflow.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6 mt-24 space-y-32">
        ...
        <section id="about-founder" className="space-y-10">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xs uppercase tracking-[0.3em] font-bold text-neutral-400">
              The Human Behind
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
            ...
            <div className="md:col-span-8 space-y-6">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed text-justify">
                Saya adalah mahasiswa **Sistem Informasi di UIN Raden Fatah
                Palembang** yang berfokus pada **Fullstack Web Development**.
                Ketertarikan saya pada teknologi mendorong saya untuk mendirikan
                **devflow.**, sebuah wadah untuk menciptakan solusi digital yang
                efisien dan automasi AI.
              </p>
        ...
        <section id="tech-stack" className="space-y-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <MagicCard
                key={item.name}
                className="p-6 border-neutral-200 dark:border-neutral-800"
        ...
        <footer className="pt-20 pb-10 text-center border-t border-neutral-100 dark:border-neutral-900">
          <p className="text-neutral-500 text-sm mb-6">
            Punya ide proyek menarik untuk dikembangkan?
          </p>
          <Link
            href="/#contact"
